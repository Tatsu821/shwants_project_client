  ...
  <v-app>
    ...
    <v-main class="v-main">
      <v-container class="body">
        ...
        <div class="add-button"><add-button class="autumn-up-btn" v-on:urlList="receiveChildMessage" /></div>
      </v-container>
    </v-main>
  </v-app>
</template>
...
export default {
  ...
  methods: {
    ...
    check: async function (n) {
      ...
      if (result) {
        var param = n;
        this.delpath = await axios.post(`${endpoint}/autumn/delete`, param);
    ...
    receiveChildMessage(e) {
      ...
      for (let i = 0; i < this.path.length; i++) {
        ...
        let fixPath = require("../../../backend/autumn_files/" + element[2]);
        // console.log(fixPath);
  ...
  async mounted() {
    this.path = await axios.get(`${endpoint}/autumn/get`);
...
.v-main {
  ...
  background-image: url(../background_image/D2AB614A-B450-45CD-AE5E-0A80D7A0C0D8_1_105_c.jpeg);
